...
// Tiptap UI
import { ColorItem, TEXT_COLORS, useColorText } from "../../ui/color-text-button";
import { HIGHLIGHT_COLORS, useColorHighlight } from "../../ui/color-highlight-button";
import type { RecentColor } from "../../ui/color-text-popover";
import { getColorByValue, useRecentColors } from "../../ui/color-text-popover";
				...
				style={
					{
						...
						"--highlight-border-color": color.border,
...
export const ColorMenu: React.FC<ColorMenuProps> = ({
	...
	return (
		<Menu placement={placement} trigger={trigger || defaultTrigger}>
			<MenuContent portal preventBodyScroll={true}>
				<ComboboxList>
