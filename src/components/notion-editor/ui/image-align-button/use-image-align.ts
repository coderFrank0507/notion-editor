...
// --- Icons ---
import { AlignCenterVerticalIcon } from "../../icons/align-center-vertical-icon";
import { AlignEndVerticalIcon } from "../../icons/align-end-vertical-icon";
import { AlignStartVerticalIcon } from "../../icons/align-start-vertical-icon";
 ...
 */
export function useImageAlignActive(
	editor: Editor | null,
	align: ImageAlign,
	extensionName: string = "image",
	attributeName: string = "data-align",
	...
	const editorState = useEditorState({
		...
		selector: ({ editor }) => {
			...
			if (selection instanceof NodeSelection && selection.node.type.name === "image") {
				return selection.node.attrs[attributeName] ?? "left";
			}
...
export function useImageAlign(config: UseImageAlignConfig) {
	...
	const isActive = useImageAlignActive(editor, align, extensionName, attributeName);
